...
- `index.html` (Home)
- `smart-brujula.html`
- `wa-smart-ventas.html`
- `censo-comercial.html`
- `geolocalizacion.html`
- `ruteo-comercial.html`
- `partners.html`
...
`bio.html`, `booking.html` y `success.html` no forman parte de este
rediseño y no se tocan.

Cuando el rediseño esté aprobado, se promueven estos archivos a la raíz
del repo (reemplazando los actuales) en un solo commit.
